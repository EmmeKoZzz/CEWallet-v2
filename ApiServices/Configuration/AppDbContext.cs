	...
	protected override void OnModelCreating(ModelBuilder modelBuilder) {
		...
		modelBuilder.Entity<Role>(entity => {
			...
			entity.HasData(new Role {
					Id = Guid.NewGuid(),
					Name = UserRole.Value(UserRole.Type.Assessor)
				},
				new Role {
					Id = Guid.NewGuid(),
					Name = UserRole.Value(UserRole.Type.Supervisor)
				},
				new Role {
					Id = adminRoleId,
					Name = UserRole.Value(UserRole.Type.Administrator)
				});
		});
